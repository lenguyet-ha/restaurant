...
//   const fullUrl = `${baseUrl}/${normalizePath}`
...
//             // Redirect về trang login có thể dẫn đến loop vô hạn nếu k đc xử lý đúng cách vì nếu rời vaò trường hợp
//             // tại trang login chúng ta có gọi các API cần access token
//             // mà access token đã bị xoá thì nó lại nhảy vào đây, và cứ thế bị lặp
//             location.href = '/login'
//           }
//         }
//       } else {
